...
Builds clusters of orthologous groups from the faMCL normalCluster.clus file. This script will build áll the clusters given in the .clus file, not just the panorthologs.
